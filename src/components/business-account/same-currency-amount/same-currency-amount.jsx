            ...
            <form className="mt-5 w-2/3 flex flex-col justify-center items center">
                <div className="">
                    ...
                    <div>
                        ...
                        <p><span>£0.00</span> It's Free</p>
                    </div>
                    <div>
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
                            <path d="M13.4902 6.70484C13.4902 9.7811 10.9964 12.2749 7.92017 12.2749C4.8439 12.2749 2.3501 9.7811 2.3501 6.70484C2.3501 3.62857 4.8439 1.13477 7.92017 1.13477C10.9964 1.13477 13.4902 3.62857 13.4902 6.70484Z" fill="black" fill-opacity="0.06"/>
                            <path d="M12.7346 6.70435C12.7346 9.37044 10.5733 11.5317 7.90723 11.5317C5.24113 11.5317 3.07983 9.37044 3.07983 6.70435C3.07983 4.03825 5.24113 1.87695 7.90723 1.87695C10.5733 1.87695 12.7346 4.03825 12.7346 6.70435Z" fill="black" fill-opacity="0.06"/>
                            <path d="M1.22314 14.8738C2.78442 12.8416 5.23923 11.5317 7.99997 11.5317C10.7607 11.5317 13.2155 12.8416 14.7768 14.8738M12.7346 6.70435C12.7346 9.37044 10.5733 11.5317 7.90723 11.5317C5.24113 11.5317 3.07983 9.37044 3.07983 6.70435C3.07983 4.03825 5.24113 1.87695 7.90723 1.87695C10.5733 1.87695 12.7346 4.03825 12.7346 6.70435Z" stroke="#99999C" stroke-width="1.8" stroke-linecap="round"/>
                        </svg>
                        <p>
                            <span>Jumat Jestofunmi Obi gets</span>
                            <span>0.00 NGN</span>
                        </p>
                    </div>
                    <div>
...
export default SameCurrencyAmount;